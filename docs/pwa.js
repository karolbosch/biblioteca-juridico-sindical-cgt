...
if("serviceWorker"in navigator&&manifest){const manifestUrl=new URL(manifest.href);navigator.serviceWorker.register(new URL("service-worker.js",manifestUrl)).catch(error=>console.warn("No se pudo registrar el modo offline",error))}
