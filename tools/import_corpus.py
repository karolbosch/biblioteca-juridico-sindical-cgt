...
FIELDS = ["title","document_type","sector","submatter","court_level","resolution_number","date","year","company","matter","outcome","procedural_status","privacy_status","source_url","source_type","document_status","chain_id","final_authority","current_rule_summary","summary","criteria","ecli","roj","case_number","appeal_number","page"]
